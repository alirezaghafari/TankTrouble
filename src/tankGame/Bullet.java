...
/**
 * the class which contains bullet properties
 */
public class Bullet {
    ...
    private static double bulletSpeed = 1.5;
    ...
    public static void setBulletSpeed() {
        bulletSpeed = 1.5 * OptionsPanel.getInstance().getBulletSpeed() / 100;
    }
}
